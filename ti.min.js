...
*/
// Please note that createPoint() and line() work under the assumption that x and y are relative to the origin aka the center of the screen and intersection of the axiis.
class Graph {
  constructor() {
